  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      ...
      <button
        ...
        className="w-14 h-14 text-white rounded-full flex items-center justify-center text-2xl transition-all hover:scale-105"
        style={{background: 'linear-gradient(135deg, #2563EB 0%, #0EA5E9 100%)', boxShadow: '0 8px 24px rgba(37, 99, 235, 0.25)'}}
      >
        {open ? "✕" : "💬"}
      </button>
    </div>
